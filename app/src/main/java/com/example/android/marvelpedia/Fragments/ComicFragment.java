...
import com.example.android.marvelpedia.Adapters.ComicDetailAdapter;
...
public class ComicFragment extends Fragment implements ComicDetailAdapter.ComicOnClick {
    ...
    private void retrieveComics() {
        ...
        Call<BaseJsonResponse<Comic>> comicCall = marvelData.getComics(retrievedCharacter.getId(), "1", apiKey, privateKey);
        Log.v(LOG_TAG, "" +
